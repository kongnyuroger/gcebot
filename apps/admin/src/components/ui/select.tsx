...
// A styled native <select> rather than a Radix Select - full accessibility
// for free, no extra dependency, and this app has no need yet for the
// richer combobox behavior Radix's version adds.
